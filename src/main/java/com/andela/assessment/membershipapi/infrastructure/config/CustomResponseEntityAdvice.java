package com.andela.assessment.membershipapi.infrastructure.config;


import com.andela.assessment.membershipapi.usecases.data.ErrorResponse;
...
@ControllerAdvice
public class CustomResponseEntityAdvice extends ResponseEntityExceptionHandler {
